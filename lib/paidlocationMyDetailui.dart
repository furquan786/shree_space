...
class PaidLocationMyDetailhistoryui extends StatefulWidget {
  String index;
  final UserType type;

  PaidLocationMyDetailhistoryui({this.index = "", required this.type, Key? key})
      : super(key: key);

  @override
  State<PaidLocationMyDetailhistoryui> createState() =>
      _PaidLocationMyDetailhistoryuiuiState();
}

class _PaidLocationMyDetailhistoryuiuiState
    extends State<PaidLocationMyDetailhistoryui> {
  List _children = [];
        ...
        title: Row(
          ...
          children: [
            ...
            Container(
                ...
                child: Text("Paid Location Detail"))
          ],
        ),
      ),
...
class _HomeholderWidgetState extends State<HomePlaceholderWidget> {
  ...
  getLocationList() async {
    locforshootList = [];
    setLoding();
    final requestData = await API.paidlocationDetailList(widget.index);
    setLoding();
