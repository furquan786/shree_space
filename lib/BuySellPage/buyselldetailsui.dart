...
class Buyselldetailsui extends StatefulWidget {
  String index;
  final UserType type;
  Buyselldetailsui({required this.index, required this.type, Key? key})
      : super(key: key);

  @override
  State<Buyselldetailsui> createState() => _BuyselldetailsuiState();
}

class _BuyselldetailsuiState extends State<Buyselldetailsui> {
                ...
                style: ButtonStyle(
                  ...
                  overlayColor:
                    ...
                    if (states.contains(MaterialState.pressed))
                      ...
                      return Colors.white; // <-- Highlight color
                  }),
                ),
              )
            ],
