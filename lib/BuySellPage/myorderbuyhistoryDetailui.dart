...
class MyorderbuyDetailhistoryui extends StatefulWidget {
  String index;
  final UserType type;

  MyorderbuyDetailhistoryui({this.index = "", required this.type, Key? key})
      : super(key: key);

  @override
  State<MyorderbuyDetailhistoryui> createState() =>
      _MyorderbuyDetailhistoryuiState();
}

class _MyorderbuyDetailhistoryuiState extends State<MyorderbuyDetailhistoryui> {
  List _children = [];
