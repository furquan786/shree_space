...
class RentBuySellCatSearchscreenui extends StatefulWidget {
  // BuySellCatSearchscreenui({Key key}) : super(key: key);
  final UserType type;

  RentBuySellCatSearchscreenui({required this.type, Key? key})
      : super(key: key);

  @override
  State<RentBuySellCatSearchscreenui> createState() =>
      _RentBuySellCatSearchscreenuiWidgetState();
}

class _RentBuySellCatSearchscreenuiWidgetState
    extends State<RentBuySellCatSearchscreenui> {
                            ...
                            Padding(
                              ...
                              child: SizedBox(
                                ...
                                child: TextField(
                                  ...
                                  onTap: () {
                                    node.unfocus();
                                    Get.to(RentBuySellCatSearchscreenui(
                                        type: widget.type));
                                  },
                              ...
                              child: ListView.separated(
                                  ...
                                  itemBuilder: (BuildContext context, int i) {
                                    return GestureDetector(
                                      onTap: () {
                                        Get.to(RentBuySelllistcategorydetailsui(
