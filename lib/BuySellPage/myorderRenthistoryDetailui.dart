...
class MyorderRentDetailhistoryui extends StatefulWidget {
  String index;
  final UserType type;
  MyorderRentDetailhistoryui({this.index = "", required this.type, Key? key})
      : super(key: key);

  @override
  State<MyorderRentDetailhistoryui> createState() =>
      _MyorderRentDetailhistoryuiState();
}

class _MyorderRentDetailhistoryuiState
    extends State<MyorderRentDetailhistoryui> {
  List _children = [];
...
class _HomeholderWidgetState extends State<HomePlaceholderWidget> {
  ...
  getOrderList() async {
    myorderList = [];
    setLoding();
    final requestData = await API.myorderRentHistoryDetailList(widget.index);
    setLoding();
