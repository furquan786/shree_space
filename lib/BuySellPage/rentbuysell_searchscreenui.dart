...
class RentBuySellSearchscreenui extends StatefulWidget {
  final UserType type;

  RentBuySellSearchscreenui({required this.type, Key? key}) : super(key: key);

  @override
  State<RentBuySellSearchscreenui> createState() =>
      _RentBuySellSearchscreenuiState();
}

class _RentBuySellSearchscreenuiState extends State<RentBuySellSearchscreenui> {
  ...
  getQueanList(String text) async {
    buysellList = [];
    final requestData = await API.rentbuysellSearchList(text);
                            ...
                            Padding(
                              ...
                              child: SizedBox(
                                ...
                                child: TextField(
                                  ...
                                  onTap: () {
                                    node.unfocus();
                                    Get.to(RentBuySellSearchscreenui(
                                        type: widget.type));
                                  },
