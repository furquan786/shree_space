...
class Myordersellhistoryui extends StatefulWidget {
  //const Myordersellhistoryui({Key key}) : super(key: key);
  final UserType type;

  Myordersellhistoryui({required this.type, Key? key}) : super(key: key);

  @override
  State<Myordersellhistoryui> createState() => _MyordersellhistoryuiState();
}

class _MyordersellhistoryuiState extends State<Myordersellhistoryui> {
