...
class Myorderhistoryui extends StatefulWidget {
  // const Myorderhistoryui({Key key}) : super(key: key);
  final UserType type;

  Myorderhistoryui({required this.type, Key? key}) : super(key: key);

  @override
  State<Myorderhistoryui> createState() => _MyorderhistoryuiState();
}

class _MyorderhistoryuiState extends State<Myorderhistoryui> {
  List _children = [];
