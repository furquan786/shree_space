...
class MyordersellRenthistoryui extends StatefulWidget {
  // const MyordersellRenthistoryui({Key key}) : super(key: key);
  final UserType type;

  MyordersellRenthistoryui({required this.type, Key? key}) : super(key: key);
  @override
  State<MyordersellRenthistoryui> createState() =>
      _MyordersellRenthistoryuiState();
}

class _MyordersellRenthistoryuiState extends State<MyordersellRenthistoryui> {
        ...
        title: Row(
          ...
          children: [
            ...
            Container(
                ...
                child: Text("Sell Order Rent History"))
          ],
        ),
      ),
