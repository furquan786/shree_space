...
class ITRVIewAttachmentui extends StatefulWidget {
  String image;
  final UserType type;

  ITRVIewAttachmentui({this.image = "", required this.type, Key? key})
      : super(key: key);

  @override
  State<ITRVIewAttachmentui> createState() => _ITRVIewAttachmentuiuiState();
}

class _ITRVIewAttachmentuiuiState extends State<ITRVIewAttachmentui> {
  List _children = [];
