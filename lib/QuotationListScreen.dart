...
class QuotationListScreen extends StatefulWidget {
  ...
  QuotationListScreen({required this.type, Key? key}) : super(key: key);
            ...
            title: Row(
              ...
              //width: 150,
                ...
                Container(
                    ...
                    child: const Text("Quotation Book"))
              ],
            ),
          ),
...
class _HomeholderWidgetState extends State<HomePlaceholderWidget> {
  ...
  getQuotationList() async {
    ...
    setLoding();
    final requestData = await API.quotationList(user_id);
    setLoding();
                              ...
                              child: ListView.separated(
                                  ...
                                  itemBuilder: (BuildContext context, int i) {
                                    ...
                                    return GestureDetector(
                                      onTap: () {
                                        Get.to(QuotationDetailhistoryui(
                                            index:
                                                quotationList[i].id.toString(),
                                            type: widget.type!));
                                      },
                                      child: Container(
                                        decoration: BoxDecoration(
      ...
      child: MaterialButton(
          ...
          onPressed: () async {
            Navigator.push(
              context,
              MaterialPageRoute(
                  builder: (context) => AddQuotationBookui(type: widget.type!)),
            );
          }),
    );
  }
