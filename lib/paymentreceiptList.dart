...
class PaymentReceiptui extends StatefulWidget {
  final UserType type;

  PaymentReceiptui({required this.type, Key? key}) : super(key: key);

  @override
  State<PaymentReceiptui> createState() => _PaymentReceiptuiState();
}

class _PaymentReceiptuiState extends State<PaymentReceiptui> {
            ...
            title: Row(
              ...
              //width: 150,
                ...
                Container(
                    ...
                    child: const Text("Payment Receipt List"))
              ],
            ),
          ),
...
class _HomeholderWidgetState extends State<HomePlaceholderWidget> {
  ...
  getQuotationList() async {
    ...
    setLoding();
    final requestData = await API.getPaymentReceiptList(user_id);
    setLoding();
    if (requestData.status == 1) {
      for (var i in requestData.result) {
        paymentReceiptList.add(PaymentReceiptModel.fromJson(i));
      }
      setState(() {});
    }
  }
          ...
          child: SingleChildScrollView(
            child: Column(
                ...
                children: [
                  ...
                  paymentReceiptList == null
                      ? Center()
                      : paymentReceiptList.isEmpty
                          ? Center(
                              child: Text(
                              "No Data Found",
                          ...
                          : Padding(
                              ...
                              child: ListView.separated(
                                  ...
                                  itemCount: paymentReceiptList.length,
                                  itemBuilder: (BuildContext context, int i) {
                                    var stringList1 = paymentReceiptList[i]
                                        .startDate
                                        .toIso8601String()
                                    ...
                                    var stringList2 = paymentReceiptList[i]
                                        .endDate
                                        .toIso8601String()
                                        .split(new RegExp(r"[T\.]"));
                                    enddate =
