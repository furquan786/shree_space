...
class MyLocationForshootList extends StatefulWidget {
  // const MyAnnouncement({Key key}) : super(key: key);
  final UserType type;

  MyLocationForshootList({required this.type, Key? key}) : super(key: key);

  @override
  State<MyLocationForshootList> createState() => _MyLocationForshootListState();
}

class _MyLocationForshootListState extends State<MyLocationForshootList> {
        ...
        title: Row(
          ...
          children: [
            ...
            Container(
                ...
                child: const Text("My Location List"))
          ],
        ),
      ),
