...
class AnnuonacementDetailhistoryui extends StatefulWidget {
  String index;
  final UserType type;

  AnnuonacementDetailhistoryui({this.index = "", required this.type, Key? key})
      : super(key: key);

  @override
  State<AnnuonacementDetailhistoryui> createState() =>
      _AnnuonacementDetailhistoryuiState();
}

class _AnnuonacementDetailhistoryuiState
    extends State<AnnuonacementDetailhistoryui> {
  List _children = [];
                              ...
                              child: ListView.separated(
                                  ...
                                  itemBuilder: (BuildContext context, int i) {
                                    /*  var stringList = annoList[i]
                                        .anno_date_new.toIso8601String().split(new RegExp(r"[T\.]"));
                                    formatedDate =
