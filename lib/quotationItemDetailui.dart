...
class QuotationItemDetailhistoryui extends StatefulWidget {
  String index;
  final UserType type;

  QuotationItemDetailhistoryui({this.index = "", required this.type, Key? key})
      : super(key: key);

  @override
  State<QuotationItemDetailhistoryui> createState() =>
      _QuotationItemDetailhistoryuiState();
}

class _QuotationItemDetailhistoryuiState
    extends State<QuotationItemDetailhistoryui> {
  List _children = [];
...
class _HomeholderWidgetState extends State<HomePlaceholderWidget> {
  ...
  getQuotationItemList() async {
    quotationitemList = [];
    setLoding();
    final requestData = await API.quotationItemDetailList(widget.index);
    setLoding();
