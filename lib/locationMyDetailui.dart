...
import 'Updatelocationforshoot.dart';
...
class LocationMyDetailhistoryui extends StatefulWidget {
  String index;
  final UserType type;

  LocationMyDetailhistoryui({this.index = "", required this.type, Key? key})
      : super(key: key);

  @override
  State<LocationMyDetailhistoryui> createState() =>
      _LocationMyDetailhistoryuiState();
}

class _LocationMyDetailhistoryuiState extends State<LocationMyDetailhistoryui> {
  List _children = [];
                                                                ...
                                                                child:
                                                                  ...
                                                                  child:
                                                                      ElevatedButton(
                                                                          ...
                                                                          onPressed:
                                                                              () async {
                                                                            Get.to(UpdateLocationForShootui(
                                                                                index: locforshootList[i].id.toString(),
                                                                                type: widget.type!));
                                                                          },
                                                                          child:
                                                                              Text(
